...
<head>
    ...
    <title>Setup Your Account | Digicert SMKN 71</title>
        ...
        <div class="col-lg-4 col-md-6 col-sm-8 col-10"> <!-- Bootstrap grid -->
            <div class="login-box shadow p-4 rounded bg-white">
                <form action="../service/auth.php" method="POST">
                    ...
                    <div class="mb-4">
                        <h2 class="text-center">Setup Akun</h2>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="f_name" class="form-control" id="f_name" name="f_name" placeholder="Enter nama lengkap" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="phone_number" name="phone_number" placeholder="Enter nomor telepon" required>
                        </div>
                    </div>
                    ...
                    <div class="d-grid mb-4">
                        <button type="submit" name="type" value="setup_account" class="btn btn-primary">Change</button>
                    </div>
                </form>
            </div>
        </div>
